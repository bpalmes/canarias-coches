...
export default function Delegaciones() {
  const delegaciones = [
    {
      nombre: "CanariasCoches.com Las Palmas",
    ...
    {
      nombre: "Taller CanariasCoches.com Clientes - Las Palmas",
    ...
    {
      nombre: "CanariasCoches.com Telde",
    ...
    {
      nombre: "CanariasCoches.com Vecindario",
    ...
    {
      nombre: "CanariasCoches.com Carrizal",
    ...
    {
      nombre: "CanariasCoches.com Tenerife",
    ...
    {
      nombre: "CanariasCoches.com Lanzarote",
    ...
    {
      nombre: "Taller CanariasCoches.com Clientes - Lanzarote",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Grupo CanariasCoches.com en su expansión tomó una decisión de un crecimiento sostenible. Empezamos en Gran Canaria donde fuimos consolidando el negocio entre la exposición de Las Palmas y de la Telde.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <p>
              <strong>2024:</strong> Hemos abierto Taller Oficial CanariasCoches.com Clientes (Miller Bajo) y Taller Oficial CanariasCoches.com Lanzarote Clientes (Arrecife).
            </p>
            <p className="text-primary font-semibold">
              El proyecto del Grupo CanariasCoches.com continúa y habrá otras aperturas que iremos informando durante el ejercicio del 2024-25.
            </p>
          </div>
        </div>
